...
from ciphers.AES import encrypt_AES
...
# Plain text (if in AES give hexadecimal of size 32) for example \"123456ABCD132536123456ABCD132536\" : \n''')
        ...
        # elif a == 8:
        #     k = input("Key should be given (as a string but hexadecimal value of size 32 [128 bit]) -> \"ABCDEFABCDEF1233ABCDEFABCDEF1233\" : ")
        #     message = encrypt_AES(mess,k)
        #     print("AES enabled")
        # else:
